...
const imageUrl = [
  'https://s29755.pcdn.co/wp-content/uploads/2019/03/Amazon_Pulls_1-1.jpg'
]   
  ...
  return (
    <Card sx={{ boxShadow: '0 5px 3px 0px #eeedf0',  margin: 5, padding: 2}}>
      ...
      <CardMedia
        ...
        alt="green iguana"
      />
      <Typography variant="body2" color="text.secondary">s simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the le</Typography>
      <Typography variant="subtitle1" color="text.primary" sx={{paddingTop: 5}}>
          Friend Requests
      </Typography>
      <FriendRequests />
